...
class StopwordPolicy:
    ...
    title_phrases: frozenset[str] = frozenset()
...
def load_stopword_policy(
    ...
    *,
    ...
    phrase_file = directory.joinpath("title_phrases.txt")
    phrases = _read_word_file(phrase_file) if phrase_file.is_file() else set()
    ...
    return StopwordPolicy(
        ...
        title_phrases=frozenset(phrases - allowlist),
    )
